...
@implementation ENNativePushManager

static ENNativePushManager *singletion = nil;
...
+ (void)PushEningViewController:(NSString *)url animated:(BOOL)Yes reverseBlock:(void (^)(id))reverse{
    [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"dicForPushNotification"];
